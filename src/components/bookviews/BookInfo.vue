<template>
  <div>
    ...
    <bs-author-links :authors="book.authors" classes="pb-0 subtitle-1"></bs-author-links>
    <v-card-text
    ...
    ></v-card-text>
    <v-card-text class="pb-0 pt-1 subtitle-1" v-text="`Pages: ${book.pages}`"></v-card-text>
